...
const SMS_TEMPLATES = {
  ...
  newOffer: (farmerName, produce, offerPrice, traderName) =>
    `SokoLeo: Habari ${farmerName}! Mfanyabiashara ${traderName} amekupa ofa ya KES ${offerPrice}/kg kwa ${produce} zako. Ingia sokoleo.onrender.com kukagua. Soko Kila Siku!`,

  offerAccepted: (traderName, produce, price, farmerName) =>
    `SokoLeo: Hongera ${traderName}! Mkulima ${farmerName} amekubali ofa yako ya KES ${price}/kg kwa ${produce}. Ingia sokoleo.onrender.com kukamilisha deal. Soko Kila Siku!`,

  offerRejected: (traderName, produce, farmerName) =>
    `SokoLeo: Pole ${traderName}. Mkulima ${farmerName} amekataa ofa yako kwa ${produce}. Jaribu tena na bei nyingine. sokoleo.onrender.com`,

  offerCountered: (traderName, produce, counterPrice, farmerName) =>
    `SokoLeo: ${traderName}, Mkulima ${farmerName} amekupa ofa ya kupinga ya KES ${counterPrice}/kg kwa ${produce}. Ingia sokoleo.onrender.com kukubaliana. Soko Kila Siku!`,
  ...
  escrowPaid: (farmerName, produce, amount, buyerName) =>
    `SokoLeo: ${farmerName}, ${buyerName} amelipa KES ${amount} kwa ${produce} zako. Pesa iko salama escrow. Toa mali na upokee malipo yako. sokoleo.onrender.com`,
  ...
  listingBoosted: (farmerName, produce, hours) =>
    `SokoLeo: ${farmerName}, orodha yako ya ${produce} imeboostiwa kwa masaa ${hours}! Wafanyabiashara wengi wataona orodha yako kwanza. Soko Kila Siku!`,
  ...
  welcomeFarmer: (name) =>
    `SokoLeo: Karibu ${name}! Umejisajili kama Mkulima. Anza kuorodhesha mazao yako leo. sokoleo.onrender.com - Soko Kila Siku!`,

  welcomeTrader: (name) =>
    `SokoLeo: Karibu ${name}! Umejisajili kama Mfanyabiashara. Anza kununua mazao bora leo. sokoleo.onrender.com - Soko Kila Siku!`,
};
